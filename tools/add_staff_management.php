...
mysqli_query($conn,"INSERT INTO useacc (username,f_name,ic_number,email,phone_no,role,status) VALUES
 ('" .$_POST['username']. "','" .$_POST['f_name']. "', '".$_POST['ic_number']. "',
 '" .$_POST['email']. "','" .$_POST['phone_no']. "','" .$_POST['role']. "','" .$_POST['status']."')");
...
<body>
  ...
  <h2>Add New Staff</h2>
		<form method="post" action="add_staff_management.php">
