...
<a href="add_patient.php" class="btn btn-primary" role="button">Add New Patient</a>
...
if($result-> num_rows>0){
  while($row = $result -> fetch_assoc()){
    ...
    ?>
    <?php echo "<th>" ;?>
    <a href = "patient_detail.php?ic_number=<?php echo $row['ic_number']; ?>"class="btn btn-primary" role="button">View Detail</a>
    <?php echo "</th>" ;?>
    <?php echo "</tr>" ;?>
